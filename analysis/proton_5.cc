...
void proton_5()
{
    ...
    double energies[n_values] = {228,220,202,189,184,179,174,154,143,125,106,91,70};
    ...
    for(int run_number=0; run_number<n_values; run_number++)
    {
        ...
        TFile *file = new TFile("../output_files/proton_5_run_"+n_run+".root");
    ...
    TFile *output = new TFile("./proton_5.root","RECREATE");
    g_edepMean->Write();
    g_edepMode->Write();
    g_edepMedian->Write();
    //g_track_len->Write();
