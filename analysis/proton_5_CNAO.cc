...
void proton_5_CNAO()
{
    ...
    double energies[n_values] = {181.8,179.9,179,178,177,176.1,175.1,174.1};
    ...
    for(int run_number=0; run_number<n_values; run_number++)
    {
        ...
        TFile *file = new TFile("../output_files/proton_5_CNAO_run_"+n_run+".root");
    ...
    TFile *output = new TFile("./proton_5_CNAO.root","RECREATE");
    g_edepMean->Write();
    g_edepMode->Write();
    g_edepMedian->Write();
    //g_track_len->Write();
